...
def test_personalized_recommendations(seeded_mongo_manager, model_path):
    ...
    from ui.data_access import fetch_personalized_recommendations
    recs, err = fetch_personalized_recommendations(USER_A, top_n=5)
...
def test_personalized_recommendations_empty_history(seeded_mongo_manager, model_path):
    ...
    from ui.data_access import fetch_personalized_recommendations
    recs, err = fetch_personalized_recommendations("user_no_activity", top_n=5)
